...
function run_model(simdir) # set add_ts to be true if anything other than the params in the powermodels file needs to be changed
    setup_simdir(simdir)
    ...
    model = create_model_n2(data, optimizer)
